...
class InputTransactionWindow(MainWindow):
    def __init__(self, app):
        ...
        # Add notebook tabbed widget container
    ...
    def create_income_tab(self):
        self.income_frame = tk.Frame(self.notebook) # initialize income frame
        self.income_categories = ["Salary", "Investment", "Other"] # initialize income categories
        ...
        self.income_entry = tk.Entry(self.income_frame, width=30) # initialize income entry
        self.income_entry.pack(pady=4) # pack the income entry widget by 4 pixels

        tk.Button(self.income_frame, text="Submit Income", command=self.add_income).pack(pady=4) # pack the Button by 4 pixels

        self.income_tree = ttk.Treeview(self.income_frame, columns=("Amount"), show="tree headings", height=8) # Create the treeview
        self.income_tree.pack(fill=tk.BOTH, expand=True, pady=8)
        self.income_tree.heading("#0", text="Category") # Use #0 for the first column (column ID)
    ...
    def create_expense_tab(self):
        ...
        self.expense_tree = ttk.Treeview(self.expense_frame, columns=("Amount"), show="tree headings", height=8)  # Create the treeview
